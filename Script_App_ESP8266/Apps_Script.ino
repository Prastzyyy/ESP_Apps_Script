...
function doGet(e) { 
  ...
  if (e.parameter == 'undefined') {
    ...
    var sheet_name = "ESP8266_Spreedsheet_Test";  // Sheet Name in Google Sheets.
    ...
    var Data_for_H3; //var Data_for_I3;
    var Data_for_I3; //var Data_for_J3;
    var Data_for_J3; //var Data_for_K3;
    var Data_for_K3; //var Data_for_L3;
    var Data_for_L3; //var Data_for_M3;
    var Data_for_M3; //var Data_for_N3;
    ...
    for (var param in e.parameter) {
      ...
      switch (param) {
        ...
        case 'data1':
          ...
          Data_for_J3 = value;  // Sensor Reading Status will be written in column K3 (in the "Latest DHT11 Sensor Data" section).
        ...
        case 'status2':
          ...
          Data_for_M3 = value;  // The state of Switch_1 will be written in column N3 (in the "Latest DHT11 Sensor Data" section).
